...
# ALGORITMO DO JANTAR DOS FILÓSOFOS EM PYTHON, ATIVIDADE 5.
...
class Filosofo(Thread):
    ...
    def comer(self):
        ...
        pratos[nomes.index(self.nome)] += 1  # quantidade de vezes que cada filosofo comeu
        print(pratos)
        hashi1.release()  # libera o hashi numero 1
        hashi2.release()  # libera o hashi numero 2


nomes = ['Aristóteles', 'Platão', 'Sócrates', 'Pitágoras', 'Joseval']  # Nomes dos filósofos
...
for _ in range(50):
    ...
    for filosofo in mesa:
        try:
            ...
            sleep(2)
        except RuntimeError:  # Verifica se a thread já tiver sido iniciada
            pass
    sleep(uniform(5, 15))
    Filosofo.execute = False  # Encerra a execução